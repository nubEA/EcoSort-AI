    ...
    <div className="min-h-screen w-full relative bg-black">
      ...
      >
        ...
        >
          ...
          >
            <path d="M32 2L2 18v28l30 16 30-16V18L32 2zM32 8l24 13.333v21.334L32 56 8 42.667V21.333L32 8z" />
          </svg>
          <span className="text-lg font-bold text-primary">EcoSort AI</span>
        </Link>
