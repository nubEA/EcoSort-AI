        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Transforming <strong>waste</strong> <span>&</span> <br />
                <strong>powering</strong> <em className="italic">sustainability</em>
              </h1>
            </motion.div>
            ...
            >
              Leverage cutting-edge machine learning to automatically identify and sort waste. Increase your operational
              efficiency and achieve your sustainability goals.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Powering solutions for</p>
