            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Real-Time Classification</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Our model processes live video feeds to identify and categorize waste types instantly, integrating
                      directly with your sorting hardware.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Organic", "Plastic", "Glass"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                        ...
                        <div className="flex flex-col gap-3">
                          {["Recycle", "Compost", "Landfill"].map((item, index) => (
                            <motion.div
                              key={`right-${index}`}
                              className="bg-white rounded px-3 py-2 flex items-center gap-2 text-black text-sm font-medium shadow-sm"
                              initial={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Extensive Waste Database</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Trained on a massive, diverse dataset of waste items from around the world, ensuring high accuracy
                      across different regions and item types.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Analytics Dashboard</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Track your sorting efficiency, waste composition, and diversion rates with our intuitive,
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      <div className="p-4">
                        <textarea
                          ...
                          placeholder="Search analytics, e.g., 'PET plastics'..."
                          value={inputValue}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Fully Responsive Dashboard</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Access your analytics from anywhere. Our dashboard is fully responsive, from the factory floor
                      tablet to your office desktop.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <img
                      ...
                      alt="Responsive Analytics Dashboard"
